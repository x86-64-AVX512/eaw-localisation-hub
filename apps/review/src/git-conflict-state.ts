...
export function resetExternalConflicts(state: ConflictState, source = ''): void {
  if (!source) {
...
export function storeExternalConflict(state: ConflictState, message: ReviewExternalConflict): void {
