...
$packageRoot = Join-Path $projectRoot 'dist\EaW-Hub-Client-0.8.7F4'
$archivePath = Join-Path $projectRoot 'dist\EaW-Hub-Client-0.8.7F4.zip'
...
if ($version -ne '0.8.7F4') { throw "Unexpected client package version: $version" }
