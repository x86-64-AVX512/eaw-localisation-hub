...
$packageRoot = Join-Path $projectRoot 'dist\EaW-Hub-Client-0.8.7F10'
$archivePath = Join-Path $projectRoot 'dist\EaW-Hub-Client-0.8.7F10.zip'
...
if ($version -ne '0.8.7F10') { throw "Unexpected client package version: $version" }
