...
$packageRoot = Join-Path $projectRoot 'dist\EaW-Hub-Client-0.8.7F5'
$archivePath = Join-Path $projectRoot 'dist\EaW-Hub-Client-0.8.7F5.zip'
...
if ($version -ne '0.8.7F5') { throw "Unexpected client package version: $version" }
