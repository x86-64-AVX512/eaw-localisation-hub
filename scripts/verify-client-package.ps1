...
$packageRoot = Join-Path $projectRoot 'dist\EaW-Hub-Client-0.8.8F2'
$archivePath = Join-Path $projectRoot 'dist\EaW-Hub-Client-0.8.8F2.zip'
...
if ($version -ne '0.8.8F2') { throw "Unexpected client package version: $version" }
