...
$packageRoot = Join-Path $projectRoot 'dist\EaW-Hub-Client-0.8.7F11'
$archivePath = Join-Path $projectRoot 'dist\EaW-Hub-Client-0.8.7F11.zip'
...
if ($version -ne '0.8.7F11') { throw "Unexpected client package version: $version" }
