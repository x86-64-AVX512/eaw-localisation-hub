...
$packageRoot = Join-Path $projectRoot 'dist\EaW-Hub-Client-0.8.8F1'
$archivePath = Join-Path $projectRoot 'dist\EaW-Hub-Client-0.8.8F1.zip'
...
if ($version -ne '0.8.8F1') { throw "Unexpected client package version: $version" }
