...
$packageRoot = Join-Path $projectRoot 'dist\EaW-Hub-Client-0.8.7F7'
$archivePath = Join-Path $projectRoot 'dist\EaW-Hub-Client-0.8.7F7.zip'
...
if ($version -ne '0.8.7F7') { throw "Unexpected client package version: $version" }
