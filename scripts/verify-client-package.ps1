...
$packageRoot = Join-Path $projectRoot 'dist\EaW-Hub-Client-0.8.7F13'
$archivePath = Join-Path $projectRoot 'dist\EaW-Hub-Client-0.8.7F13.zip'
...
if ($version -ne '0.8.7F13') { throw "Unexpected client package version: $version" }
