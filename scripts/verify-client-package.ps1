...
$packageRoot = Join-Path $projectRoot 'dist\EaW-Hub-Client-0.8.7F3'
$archivePath = Join-Path $projectRoot 'dist\EaW-Hub-Client-0.8.7F3.zip'
...
if ($version -ne '0.8.7F3') { throw "Unexpected client package version: $version" }
