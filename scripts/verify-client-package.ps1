...
$packageRoot = Join-Path $projectRoot 'dist\EaW-Hub-Client-0.8.7F12'
$archivePath = Join-Path $projectRoot 'dist\EaW-Hub-Client-0.8.7F12.zip'
...
if ($version -ne '0.8.7F12') { throw "Unexpected client package version: $version" }
