...
function Open-AdminSession {
    ...
    $form.Text = if ($TeamManagement) {
        'EaW Localisation Hub 0.8.7F9 – Управление командой'
    } else {
        'EaW Localisation Hub 0.8.7F9 – Администратор'
    }
}
...
$form.Text = if ($TeamManagement) { 'EaW Localisation Hub 0.8.7F9 – Управление командой' } else { 'EaW Localisation Hub 0.8.7F9 – Администратор' }
