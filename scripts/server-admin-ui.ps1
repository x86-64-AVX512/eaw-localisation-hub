...
function Open-AdminSession {
    ...
    $form.Text = if ($TeamManagement) {
        'EaW Localisation Hub 0.8.7F8 – Управление командой'
    } else {
        'EaW Localisation Hub 0.8.7F8 – Администратор'
    }
}
...
$form.Text = if ($TeamManagement) { 'EaW Localisation Hub 0.8.7F8 – Управление командой' } else { 'EaW Localisation Hub 0.8.7F8 – Администратор' }
