...
function Open-AdminSession {
    ...
    $form.Text = if ($TeamManagement) {
        'EaW Localisation Hub 0.8.8F1 – Управление командой'
    } else {
        'EaW Localisation Hub 0.8.8F1 – Администратор'
    }
}
...
$form.Text = if ($TeamManagement) { 'EaW Localisation Hub 0.8.8F1 – Управление командой' } else { 'EaW Localisation Hub 0.8.8F1 – Администратор' }
