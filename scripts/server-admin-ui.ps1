...
function Open-AdminSession {
    ...
    $form.Text = if ($TeamManagement) {
        'EaW Localisation Hub 0.8.8F3 – Управление командой'
    } else {
        'EaW Localisation Hub 0.8.8F3 – Администратор'
    }
}
...
$form.Text = if ($TeamManagement) { 'EaW Localisation Hub 0.8.8F3 – Управление командой' } else { 'EaW Localisation Hub 0.8.8F3 – Администратор' }
