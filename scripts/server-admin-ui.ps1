...
function Open-AdminSession {
    ...
    $form.Text = if ($TeamManagement) {
        'EaW Localisation Hub 0.8.7F13 – Управление командой'
    } else {
        'EaW Localisation Hub 0.8.7F13 – Администратор'
    }
}
...
$form.Text = if ($TeamManagement) { 'EaW Localisation Hub 0.8.7F13 – Управление командой' } else { 'EaW Localisation Hub 0.8.7F13 – Администратор' }
