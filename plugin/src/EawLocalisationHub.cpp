...
constexpr wchar_t kPluginName[] = L"EaW Localisation Hub 0.8.7F12";
...
void EnsurePanel(bool show) {
    if (!g_panel) {
        ...
        g_panelDockData.pszAddInfo = L"EaW Hub 0.8.7F12";
...
void HandleAgentLine(const std::string& json) {
    ...
    if (type == "ipcChallenge") {
        ...
        WritePipeLine(
            ...
            + "\",\"version\":\"0.8.7F12\",\"protocol\":" + std::to_string(kProtocolVersion) + ",\"proof\":\""
